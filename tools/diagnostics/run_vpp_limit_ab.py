...
def main():
    ...
    import hashlib
    binary=ROOT/'demos/hdmi_wall/build-vpp-limit/hdmi_wall.pcie'
    ...
    cases=[('limit0','sync',10),('limit2','sync',10),('limit4','sync',10)]
    ...
    try:
        for rep,(case,preview_stage,rate) in plan:
            ...
            if case != 'original':
                cmd[0]=str(ROOT/'demos/hdmi_wall/build-vpp-limit/hdmi_wall.pcie')
                cmd+=['--preview-mode',preview_stage]
            ...
            cmd=['env','HDMI_VPP_LIMIT='+case[5:]]+cmd
